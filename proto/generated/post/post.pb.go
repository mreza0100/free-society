...
type GetPostResponseInner struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetPostResponseInner) Reset() {
	*x = GetPostResponseInner{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetPostResponseInner) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPostResponseInner) ProtoMessage() {}

func (x *GetPostResponseInner) ProtoReflect() protoreflect.Message {
	mi := &file_post_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPostResponseInner.ProtoReflect.Descriptor instead.
func (*GetPostResponseInner) Descriptor() ([]byte, []int) {
	return file_post_proto_rawDescGZIP(), []int{3}
}

func (x *GetPostResponseInner) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *GetPostResponseInner) GetBody() string {
	if x != nil {
		return x.Body
	}
	return ""
...
func (x *GetPostResponseInner) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GetPostResponseInner) GetOwnerId() uint64 {
	if x != nil {
		return x.OwnerId
	}
	return 0
...
type GetPostResponse struct {
	...
	Posts []*GetPostResponseInner `protobuf:"bytes,1,rep,name=posts,proto3" json:"posts,omitempty"`
}
...
func (x *GetPostResponse) GetPosts() []*GetPostResponseInner {
	if x != nil {
		return x.Posts
	}
	return nil
...
var file_post_proto_rawDesc = []byte{
	...
	0x65, 0x50, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x22, 0x0a,
	...
	0x73, 0x22, 0x6a, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x50, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x49, 0x6e, 0x6e, 0x65, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74,
	0x6c, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x12,
	0x12, 0x0a, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x62,
	0x6f, 0x64, 0x79, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x02, 0x69, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x49, 0x64, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x49, 0x64, 0x22, 0x43, 0x0a,
	...
	0x1a, 0x2e, 0x70, 0x6f, 0x73, 0x74, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x6f, 0x73, 0x74, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x49, 0x6e, 0x6e, 0x65, 0x72, 0x52, 0x05, 0x70, 0x6f, 0x73,
	0x74, 0x73, 0x22, 0x52, 0x0a, 0x0e, 0x4e, 0x65, 0x77, 0x50, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x71,
	...
	0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x21, 0x0a, 0x0f, 0x4e, 0x65, 0x77, 0x50, 0x6f, 0x73,
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x32, 0xbe, 0x01, 0x0a, 0x0b, 0x50, 0x6f,
	0x73, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x36, 0x0a, 0x07, 0x4e, 0x65, 0x77,
	...
	0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x07, 0x5a, 0x05, 0x2f, 0x70,
...
var file_post_proto_goTypes = []interface{}{
	...
	(*GetPostResponseInner)(nil), // 3: post.GetPostResponseInner
...
var file_post_proto_depIdxs = []int32{
	3, // 0: post.GetPostResponse.posts:type_name -> post.GetPostResponseInner
	5, // 1: post.PostService.NewPost:input_type -> post.NewPostRequest
	2, // 2: post.PostService.GetPost:input_type -> post.GetPostRequest
	0, // 3: post.PostService.DeletePost:input_type -> post.DeletePostRequest
	6, // 4: post.PostService.NewPost:output_type -> post.NewPostResponse
	4, // 5: post.PostService.GetPost:output_type -> post.GetPostResponse
	1, // 6: post.PostService.DeletePost:output_type -> post.DeletePostResponse
...
func file_post_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_post_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetPostResponseInner); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
